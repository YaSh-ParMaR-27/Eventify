...
const Booking = () => {
  ...
  return (<>
    <div className="container-fluid" style={{overflowX: 'scroll' }}>
      <div className="row bg-slate-600 fixed-top z-50 text-white  flex">
        ...
        <div className="col-5 p-2">
          <Link style={{ textDecoration: 'none' }} to={(600 * c + 450 * p) === 0 ? '' : '/checkout'} state={{ data, c, p, details }}>
            <Button  disabled={(600 * c + 450 * p) === 0 ? true : false} variant='contained' color='error'>Book Tickets  ({600 * c + 450 * p})</Button>
          </Link>
        </div>
      ...
      <div className='row mt-2' style={{ display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
        <h3 className=''>Prime : <CurrencyRupeeIcon fontSize='small' />600  Total Prime Count:   {c}</h3>
      ...
      <div  className='row' >
        <img className='mx-auto' src={screen} alt='screen this way' style={{ width: '50%' }} />
